...
#"> max(eruption.times)[1] 5.1> min(eruption.times)[1] 1.6"

mean(eruption.times)
median(eruption.times)

#"> mean(eruption.times)[1] 3.487783> median(eruption.times)[1] 4"
...
#"> var(eruption.times)[1] 1.302728> sd(eruption.times)[1] 1.141371"
...
#102 Hands on Lesson 4

#This is to get access to different inherent R datasets

library(datasets)

#this is to get the faithful data set

faithful

#This gives the eruptions variable as a vector 
...
#How many elements are in the short vector?

length(short)

[1] 97

# How many elements are in the long vector?

length(long)

[1] 175

#Mean wait time of short? 

mean(short)

[1] 175

#Mean wait time of long?
